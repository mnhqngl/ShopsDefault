...
<div class="prd-checkout section">
    <div class="block-header">Thuê xe</div>
        ...
        <div class="row">
            <div class="col-8">
                <div class="checkout-item">
                    <div class="title-header">Thông tin nhận xe</div>
                    <div class="checkout-content">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label for="company">Địa chỉ nhận xe</label>
                                    <asp:TextBox ID="txtAddress" runat="server" onKeyUp='validateAddress(ckAddress)' placeholder="Nhập địa chỉ nhận xe" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" placeholder="Nhập ghi chú đơn thuê xe" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-4">
                <div class="title-header">Thông tin giỏ đặt xe</div>
                <div class="checkout-content">
                    ...
                    <div class="text-center">
                        <a href="gio-hang.html" class="btn-default">Giỏ đặt xe</a>
                        <asp:LinkButton ID="btnCheckout" runat="server" OnClientClick="return validateForm(ckName, ckPhone, ckEmail, ckAddress)" OnClick="btnCheckout_Click" CssClass="btn-default">Đặt thuê xe</asp:LinkButton>
                    </div>
                    <div class="checkout-warning-text">
                        Quý khách vui lòng kiểm tra lại thông tin giỏ đặt thuê xe trước khi nhấn vào nút đặt thuê xe
                    </div>
                </div>
            </div>
        </div>
