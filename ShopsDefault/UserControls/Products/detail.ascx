...
<script type="text/javascript">
    ...
    function checkItem(quantity, e) {
        ...
        if (totalamout == 0) {
            alert("Xe này không có sẵn trong kho nên không thêm vào giỏ đặt xe được!");
            e.preventDefault();
        } else if (totalamout - parseInt(quantity) < 0) {
            alert("Xe cần thuê chênh lệch cho với xe còn trong kho nên không thêm vào giỏ đặt xe được!");
            e.preventDefault();
        } else {
