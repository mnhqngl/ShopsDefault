...
namespace Librari {
	public partial class Cls_ShopsOrders_Old
	{
		...
		/// </summary>
		public Cls_ShopsOrders_Old(int id_order, int id_product, int id_orderproduct, DateTime addtime, DateTime edittime, bool hidden)
		{
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsOrders_Old converDataRow_To_Object(DataRow dr)
		{
			Cls_ShopsOrders_Old _Object = new Cls_ShopsOrders_Old();
			//ID_Order
		...
		/// <param name="ID">ID</param>
		/// <returns></returns>
		public static Cls_ShopsOrders_Old getOject_Key(int key_ID_Order)
		{
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsOrders_Old[] getArrayObject(DataTable dt)
		{
			if (dt.Rows.Count == 0) return null;
			Cls_ShopsOrders_Old[] arr = new Cls_ShopsOrders_Old[dt.Rows.Count];
			int i = 0;
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsOrders_Old[] getArrayObject()
		{
