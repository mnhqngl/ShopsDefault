...
namespace Librari {
	public partial class Cls_NewsCatalogs
	{
		...
		protected const string TABLE_NAME = "tbNewsCatalogs";
		...
		/// </summary>
		public Cls_NewsCatalogs(int id_catalog, int id_parent, string catalogname, string image, string description, string titleweb, string linkseo, string h1seo, string keywordseo, DateTime addtime, DateTime edittime, bool hidden)
		{
		...
		public static int countRows(bool Hidden)
		{
			...
			SqlCommand sqlComm = new SqlCommand("st_tbNewsCatalogs_Count", conn);
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand("st_tbNewsCatalogs_Count_Key", conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sSQL = "Select MAX(ID_Catalog) From tbNewsCatalogs";
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sSQL = "Select Top 0 * From tbNewsCatalogs";
			SqlCommand sqlComm = new SqlCommand(sSQL, conn);
			sqlComm.CommandType = CommandType.Text;
			try
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sSQL = "Select Top " + top + " * From  tbNewsCatalogs";
			SqlCommand sqlComm = new SqlCommand(sSQL, conn);
			sqlComm.CommandType = CommandType.Text;
			try
			{
		...
		public static DataTable getDataTable_Time(string strWhere)
		{
			try
			{
				string sSQL = "SELECT * FROM tbNewsCatalogs" + strWhere;
		...
		public static DataTable getDataTable_Where(string strWhere,string FieldSort)
		{
			try
			{
				...
				string sSQL = "SELECT * FROM tbNewsCatalogs" + strWhere + FieldSort;
				return getDataTable_SQL_pro(sSQL);
			}
			catch (SqlException ex)
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbNewsCatalogs_SelectAll, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			SqlDataAdapter sqlDTA = new SqlDataAdapter(sqlComm);
			DataTable dt = new DataTable();
			try
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbNewsCatalogs_SelectByID, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			DataTable dt = new DataTable();
			try
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbNewsCatalogs_SelectAll_LikeKey, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand("st_tbNewsCatalogsSelectAll_Hidden", conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			SqlDataAdapter sqlDTA = new SqlDataAdapter(sqlComm);
			DataTable dt = new DataTable();
			try
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbNewsCatalogs_Insert, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
				//ID_Parent
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbNewsCatalogs_Update, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
				conn.Open();
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sql = "Update tbNewsCatalogs Set ID_Catalog=@ID_Catalog_New Where ID_Catalog=@ID_Catalog_old";
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbNewsCatalogs_Delete, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_NewsCatalogs converDataRow_To_Object(DataRow dr)
		{
			Cls_NewsCatalogs _Object = new Cls_NewsCatalogs();
			//ID_Catalog
		...
		/// <param name="ID">ID</param>
		/// <returns></returns>
		public static Cls_NewsCatalogs getOject_Key(int key_ID_Catalog)
		{
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_NewsCatalogs[] getArrayObject(DataTable dt)
		{
			if (dt.Rows.Count == 0) return null;
			Cls_NewsCatalogs[] arr = new Cls_NewsCatalogs[dt.Rows.Count];
			int i = 0;
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_NewsCatalogs[] getArrayObject()
		{
