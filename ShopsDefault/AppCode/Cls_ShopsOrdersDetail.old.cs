//----------------------------------------------------------------
//Tên Class: Cls_ShopsOrdersDetail_Old
...
namespace Librari {
	public partial class Cls_ShopsOrdersDetail_Old
	{
        ...
        protected const string st_tbShopsOrdersDetail_UpdateUserName = "st_tbShopsOrdersDetail_UpdateUserName";
		...
		/// </summary>
		public Cls_ShopsOrdersDetail_Old()
		{
		}
		...
		/// </summary>
		public Cls_ShopsOrdersDetail_Old(int id_orderproduct, int id_payment, int id_user, string ordersname, string username, string useremail, string useraddress, string userphone, Double pricetotal, string description, DateTime addtime, DateTime edittime, bool hidden)
		{
        ...
        /// </summary>
        /// <returns></returns>
        public int doUpdateUserName()
        {
            SqlConnection conn = new AccessDB().get_Conn();
            SqlCommand sqlComm = new SqlCommand(st_tbShopsOrdersDetail_UpdateUserName, conn);
            sqlComm.CommandType = CommandType.StoredProcedure;
            try
            {
                conn.Open();
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsOrdersDetail_Old converDataRow_To_Object(DataRow dr)
		{
			Cls_ShopsOrdersDetail_Old _Object = new Cls_ShopsOrdersDetail_Old();
			//ID_OrderProduct
		...
		/// <param name="ID">ID</param>
		/// <returns></returns>
		public static Cls_ShopsOrdersDetail_Old getOject_Key(int key_ID_OrderProduct)
		{
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsOrdersDetail_Old[] getArrayObject(DataTable dt)
		{
			if (dt.Rows.Count == 0) return null;
			Cls_ShopsOrdersDetail_Old[] arr = new Cls_ShopsOrdersDetail_Old[dt.Rows.Count];
			int i = 0;
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsOrdersDetail_Old[] getArrayObject()
		{
