//----------------------------------------------------------------
//Tên Class: Cls_ShopsCurrencyUnit
...
namespace Librari {
	public partial class Cls_ShopsCurrencyUnit
	{
		protected string sSQL;
		#region Tham số cho Procedure
		//Tham số cho Procudure
		protected const string st_tbShopsCurrencyUnit_Insert = "st_tbShopsCurrencyUnit_Insert";
		protected const string st_tbShopsCurrencyUnit_Update = "st_tbShopsCurrencyUnit_Update";
		protected const string st_tbShopsCurrencyUnit_SelectAll_Active_LikeKey = "st_tbShopsCurrencyUnit_SelectAll_Active_LikeKey";
		protected const string st_tbShopsCurrencyUnit_SelectAll_LikeKey = "st_tbShopsCurrencyUnit_SelectAll_LikeKey";
		protected const string st_tbShopsCurrencyUnit_Delete = "st_tbShopsCurrencyUnit_Delete";
		protected const string st_tbShopsCurrencyUnit_SelectByID = "st_tbShopsCurrencyUnit_SelectByID";
		protected const string st_tbShopsCurrencyUnit_SelectAll = "st_tbShopsCurrencyUnit_SelectAll";
		protected const string st_tbShopsCurrencyUnit_Count = "st_tbShopsCurrencyUnit_Count";
		protected const string st_tbShopsCurrencyUnit_Count_Key = "st_tbShopsCurrencyUnit_Count_Key";
		protected const string TABLE_NAME = "tbShopsCurrencyUnit";
		...
		public const string fn_CurrencyUnitName = "CurrencyUnitName";
		public const int len_CurrencyUnitName = 200;
		...
		//Các tên filed của table.
		private int _iD_CurrencyUnit_find;
		private int _iD_CurrencyUnit;
		private string _currencyUnitName;
		...
		//Thuộc tínhID_CurrencyUnit_find
		public int ID_CurrencyUnit_find
		{
			get{return this._iD_CurrencyUnit_find;}
			set{this._iD_CurrencyUnit_find = value;}
		}
		...
		//Thuộc tínhCurrencyUnitName
		public string CurrencyUnitName
		{
			get{return this._currencyUnitName;}
			set{this._currencyUnitName = value;}
		}
		...
		/// </summary>
		public Cls_ShopsCurrencyUnit(int id_currencyunit, string currencyunitname, string image, string description, DateTime addtime, DateTime edittime, bool hidden)
		{
			this._iD_CurrencyUnit = id_currencyunit;
			this._currencyUnitName = currencyunitname;
			this._image = image;
		...
		public static int countRows(bool Hidden)
		{
			...
			SqlCommand sqlComm = new SqlCommand("st_tbShopsCurrencyUnit_Count", conn);
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand("st_tbShopsCurrencyUnit_Count_Key", conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
		...
		/// </summary>
		/// <returns>Truy: Có; False: Không</returns>
		public static bool Exits_Key(int key_ID_CurrencyUnit)
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand("st_tbShopsCurrencyUnit_Count_Key", conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
				sqlComm.Parameters.Add("@ID_CurrencyUnit", SqlDbType.Int).Value = key_ID_CurrencyUnit;
				conn.Open();
				if (((int)sqlComm.ExecuteScalar()) == 1) return true;
				else return false;
			}
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sSQL = "Select MAX(ID_CurrencyUnit) From tbShopsCurrencyUnit";
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sSQL = "Select Top 0 * From tbShopsCurrencyUnit";
			SqlCommand sqlComm = new SqlCommand(sSQL, conn);
			sqlComm.CommandType = CommandType.Text;
			try
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sSQL = "Select Top " + top + " * From  tbShopsCurrencyUnit";
			SqlCommand sqlComm = new SqlCommand(sSQL, conn);
			sqlComm.CommandType = CommandType.Text;
			try
			{
		...
		public static DataTable getDataTable_Time(string strWhere)
		{
			try
			{
				string sSQL = "SELECT * FROM tbShopsCurrencyUnit" + strWhere;
		...
		public static DataTable getDataTable_Where(string strWhere,string FieldSort)
		{
			try
			{
				...
				string sSQL = "SELECT * FROM tbShopsCurrencyUnit" + strWhere + FieldSort;
				return getDataTable_SQL_pro(sSQL);
			}
			catch (SqlException ex)
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbShopsCurrencyUnit_SelectAll, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			SqlDataAdapter sqlDTA = new SqlDataAdapter(sqlComm);
			DataTable dt = new DataTable();
			try
		...
		/// <param name="ID">ID</param>
		/// <returns></returns>
		public static DataTable getDataTable_My(int key_ID_CurrencyUnit)
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbShopsCurrencyUnit_SelectByID, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			DataTable dt = new DataTable();
			try
			{
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbShopsCurrencyUnit_SelectAll_LikeKey, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand("st_tbShopsCurrencyUnitSelectAll_Hidden", conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			SqlDataAdapter sqlDTA = new SqlDataAdapter(sqlComm);
			DataTable dt = new DataTable();
			try
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbShopsCurrencyUnit_Insert, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
				//CurrencyUnitName
				sqlComm.Parameters.Add("@CurrencyUnitName", SqlDbType.NVarChar).Value = CurrencyUnitName;
				//Image
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbShopsCurrencyUnit_Update, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
				conn.Open();
				//ID_CurrencyUnit
				sqlComm.Parameters.Add("@ID_CurrencyUnit_find", SqlDbType.Int).Value = ID_CurrencyUnit_find;
				//CurrencyUnitName
				if (CurrencyUnitName != null)
					sqlComm.Parameters.Add("@CurrencyUnitName", SqlDbType.NVarChar).Value = CurrencyUnitName;
				else
					sqlComm.Parameters.Add("@CurrencyUnitName", SqlDbType.NVarChar).Value = DBNull.Value;
				//Image
				if (Image != null)
					sqlComm.Parameters.Add("@Image", SqlDbType.NVarChar).Value = Image;
				else
		...
		/// </summary>
		/// <returns></returns>
		public int doUpdate_KEY(string Key_ID_CurrencyUnit_Old, string Key_ID_CurrencyUnit_New)
		{
			SqlConnection conn = new AccessDB().get_Conn();
			string sql = "Update tbShopsCurrencyUnit Set ID_CurrencyUnit=@ID_CurrencyUnit_New Where ID_CurrencyUnit=@ID_CurrencyUnit_old";
			SqlCommand sqlComm = new SqlCommand(sql, conn);
			sqlComm.CommandType = CommandType.Text;
			try
			{
				sqlComm.Parameters.Add("@ID_CurrencyUnit_New", SqlDbType.Int).Value = Key_ID_CurrencyUnit_New;
				sqlComm.Parameters.Add("@ID_CurrencyUnit_old", SqlDbType.Int).Value = Key_ID_CurrencyUnit_Old;
				conn.Open();
				sqlComm.ExecuteNonQuery();
				return 1;
			}
		...
		{
			SqlConnection conn = new AccessDB().get_Conn();
			SqlCommand sqlComm = new SqlCommand(st_tbShopsCurrencyUnit_Delete, conn);
			sqlComm.CommandType = CommandType.StoredProcedure;
			try
			{
				sqlComm.Parameters.Add("@ID_CurrencyUnit", SqlDbType.Int).Value = ID_CurrencyUnit_find;
				conn.Open();
				sqlComm.ExecuteNonQuery();
				return 1;
			}
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsCurrencyUnit converDataRow_To_Object(DataRow dr)
		{
			Cls_ShopsCurrencyUnit _Object = new Cls_ShopsCurrencyUnit();
			//ID_CurrencyUnit
			...
			//CurrencyUnitName
			if(dr.Table.Columns.Contains(fn_CurrencyUnitName))
			if(dr[fn_CurrencyUnitName]!= DBNull.Value)
			_Object.CurrencyUnitName =  (string)dr[fn_CurrencyUnitName];
		...
		/// <param name="ID">ID</param>
		/// <returns></returns>
		public static Cls_ShopsCurrencyUnit getOject_Key(int key_ID_CurrencyUnit)
		{
			DataTable dt = getDataTable_My(key_ID_CurrencyUnit);
			if (dt.Rows.Count > 0)
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsCurrencyUnit[] getArrayObject(DataTable dt)
		{
			if (dt.Rows.Count == 0) return null;
			Cls_ShopsCurrencyUnit[] arr = new Cls_ShopsCurrencyUnit[dt.Rows.Count];
			int i = 0;
		...
		/// </summary>
		/// <returns></returns>
		public static Cls_ShopsCurrencyUnit[] getArrayObject()
		{
