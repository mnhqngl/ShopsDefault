...
<div class="container-fluid">
    <div class="block-default">
        <div class="block-header">
            <i class="icon-note"></i>Danh sách đơn đặt thuê xe
        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body scrollbar-y-custom">
                                    <div class="form-group d-none">
                                        <label for="company">ID đơn thuê xe</label>
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#thong-tin-don-hang">Thông tin đơn thuê xe</a>
                                        </li>
                                    </ul>
